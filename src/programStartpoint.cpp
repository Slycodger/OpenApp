...
int main() {
  ...
  Shader shader = createShader("basicShader", shaderPair, 2);
  ...
  Shader textureShader = createShader("textureShader", textureShaderPair, 2);
  ...
  progEnd();
  visual3D::visual3DEnd();
  uniqueType::uniqueTypeEnd();
}